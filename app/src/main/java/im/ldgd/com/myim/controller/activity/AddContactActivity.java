...
public class AddContactActivity extends Activity implements View.OnClickListener {
    ...
    private final EMContactListener emContactListener = new EMContactListener() {
        ...
        public void onContactAdded(String s) {
            Toast.makeText(AddContactActivity.this, "xxxxxxxxxxxxxxxxxxxxxxxonContactAdded", Toast.LENGTH_SHORT).show();
        ...
        public void onContactDeleted(String s) {
            Toast.makeText(AddContactActivity.this, "xxxxxxxxxxxxxxxxxxxxonContactDeleted", Toast.LENGTH_SHORT).show();
            LogUtil.e("onContactAdded");
        }
        ...
        public void onContactInvited(String s, String s1) {
            Toast.makeText(AddContactActivity.this, "xxxxxxxxxxxxxxxxxxxxonContactInvited", Toast.LENGTH_SHORT).show();
            LogUtil.e("onContactAdded");
        }
        ...
        public void onFriendRequestAccepted(String s) {
            Toast.makeText(AddContactActivity.this, "xxxxxxxxxxxxxxxxxxxxonFriendRequestAccepted", Toast.LENGTH_SHORT).show();
            LogUtil.e("onContactAdded");
        }
        ...
        public void onFriendRequestDeclined(String s) {
            Toast.makeText(AddContactActivity.this, "xxxxxxxxxxxxxxxxxxxxonFriendRequestDeclined", Toast.LENGTH_SHORT).show();
            LogUtil.e("onContactAdded");
        }
    };
